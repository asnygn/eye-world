    ...
    <section class="welcome">
      <Container>
        <div class="welcome__text1">
          <p>Eye World Group Provides,</p>
        </div>
        <div class="welcome__text2">
          <p>World Class Optical Equipment And Service Support</p>
        </div>
      </Container>
    </section>
            ...
            <div class="why-item">
              ...
              <div class="why-item__content">
                ...
                <div class="why-item__description">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Quisque consectetur elementum velit nec feugiat.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="news__list">
          <div class="news-item">
            ...
            <div class="news-item__title">
              Pellentesque consequat nulla et lorem
            </div>
            <div class="news-item__description">
              Vitae sagittis erat cursus. Sed nec fringilla turpis. Sed et
              mauris laoreet, malesuada enim malesuada, finibus nibh. Sed sit
...
.service-item::before {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(0, 134, 134, 0.4);
  border-radius: 10px;
  z-index: -1;
}
.service-item__title {
